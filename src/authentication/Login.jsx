...
import gp from "../assets/images/logo.png";
...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    else if (!/^[a-zA-Z0-9]+@(?:[a-zA-Z0-9]+\.)+com$/.test(username))
      // Can enter any specific username format.
  ...
  return (
    <>
      <Container
        ...
        style={{ background: "#14195d", height: "100vh" }}
        fluid
      >
        <Row className="bg-white w-2/3 py-5 pe-md-5 rounded">
          <Col xs={12} md={6} className="align-self-center">
            <Image src={gp} alt="Gujarat Police" className="d-block m-auto" />
          </Col>
          <Col xs={12} md={6}>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Form.Group className="text-end mb-3">
                <span
                  ...
                  onClick={() =>
                    toast.info("Contact Admin to change your Password!", {
                      theme: "dark",
                    })
                  }
                  className="span"
